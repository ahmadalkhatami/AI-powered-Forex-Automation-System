...
public class BacktestRunner
{
    ...
    public async Task<BacktestResult> RunAsync(BacktestParams p)
    {
        ...
        var analyzer    = new LiveSignalAnalyzer(brokerStub, stateStub, modeStub, _feed);
...
internal class BacktestSystemStateStub : ISystemStateService
{
    ...
    public decimal AutoApproveMinConfidence => 0.70m;  // standard default
    ...
    public void UpdateConfig(
        ...
        decimal? autoApproveMinConfidence = null) { /* no-op for backtest stub */ }
}
